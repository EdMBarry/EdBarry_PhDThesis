...
%% Components
  ...
  \node[name=rate,right of=XI,halfBox,minimum width=15cm, node distance=9cm]{Rate $r_j$};   
...
% Rates
 ...
 \node[name=rho2,right of=1002,rateBox]{$k_{m,ac}\frac{S_{AC}}{S_{AC}+K_{S,S{AC}}}X_{PB} I_{FA}I_{IN}I_{IP}I_E I_{ph}$};
 \node[name=rho3,right of=1003,rateBox]{$k_{m,ph}\frac{S_S}{S_S+K_{S,SS}}X_{PB} I_{FA}I_{IN}I_{IP}I_E I_{ac}$};
 ...
 \node[name=legend,below of=rho6,bigBox]{Competitive inhibition photohet: $I_{ph}=\frac{S_{AC}}{S_S + S_{AC}}$ \\
 											\\
 										  Competitive inhibition acetate: $I_{ac}=\frac{S_S}{S_S + S_{AC}}$ \\
 										  	\\
