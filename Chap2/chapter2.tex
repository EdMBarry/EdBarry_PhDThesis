...
\begin{figure}[H]
    ...
    \caption{Experimental (symbols) and modelled (lines) time curse of substrates uptake (left) and parameters determination including 95\% confidence intervals and confidence regions (right) of PPB metabolism in photoheterotrophy (a), chemoheterotrophy (b) and photoautotrophy (c).}
