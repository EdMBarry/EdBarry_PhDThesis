...
\begin{table}[tp]
    ...
    \begin{tabular}{@{}p{2cm} p{3cm} p{4cm} p{4cm} p{3cm} @{}} \toprule
        ...
        k\textsubscript{M,ph} & d\textsuperscript{-1} &1.4 $\pm$ \num{0.2}&11 $\pm$ 13 & \cite{golomysova2010, Gadhamshetty2008, Klein1991, McKinlay2011, Obeid2009a}\\
