...
\chapter[A multidimensional, phototrophic, continuum-based biofilm model]{A multidimensional, phototrophic, continuum-based biofilm model}
...
The general form of the radiative transfer equation (RTE) has been adapted to phototrophic systems \textbf{cite me} \cite{kong2014}, and includes the dependency on the concentration of solid species and water. The black body radiation term has been omitted from this equation due to its minimal influence. The electromagnetic field energy balance is presented in Eq. \eqref{eq:rteSimplifiedCh4}. 
...
\label{Hydro}
The multiphase volume of fluid flow may be calculated using the mixture mass, momentum and continuity equations as follows,
