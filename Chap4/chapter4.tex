...
\section*{Abstract}
Phototrophic bacteria growing in the presence of a radiative field have shown promise as useful technologies across a vast array of applications such as the production of natural pigments, wastewater treatment, nutrient recapture, and biofuel production. A way of minimising the non-negligible separation costs associated with harvesting these phototrophic bacteria is to ensure they grow attached to surfaces in the form of a biofilm. 
...
\skippingparagraph
A model was therefore developed using the volume of fluid (VoF) method in which phototrophic biomass could be grown on a substratum. The model did not include the effects of attachment of planktonic bacteria, nor the effects of any external flow field on the biofilm structure. Monitoring the effects of the radiative field was the major motivator of the study. The lamp source was set from below and above the biofilm on both uniformly and sparsely initiated biofilms at 30 W m\textsuperscript{-2}. An extra study was done where the lamp source was set at 10\% intensity and shone from below the biofilm. In all cases, there was phototrophic growth, however in the case of minimal irradiation, the maximum growth rate was 70\% slower than the case with 30 W m\textsuperscript{-2}. There was a difference in growth rate between biofilms irradiated from below and those irradiated from above. Maximum growth rate was 25\%-30\% slower in the cases where the radiative intensity field was initiated from above the biofilm, despite the soluble substrate not being subjected to diffusion limitations. 
\skippingparagraph
